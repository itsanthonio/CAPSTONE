...
class ModelSingleton:
    ...
    def _load_model(self):
        ...
        try:
            ...
            model_path = os.getenv('MODEL_PATH', '/Users/admin/Desktop/geo-vigil-guard/best_iou_model_6band.pth')
...
class InferenceService:
    ...
    def get_model_info(self) -> dict:
        ...
        return {
            ...
            'parameters': sum(p.numel() for p in self.model.parameters()) if hasattr(self.model, 'parameters') else 'mock_model',
