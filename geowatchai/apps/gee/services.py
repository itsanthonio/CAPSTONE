...
class GeeService:
    ...
    def select_bands(self, image: ee.Image) -> ee.Image:
        ...
        """
        try:
            # Sentinel-2 band names for RGB + NIR
            bands = ['B2', 'B3', 'B4', 'B8']  # Blue, Green, Red, NIR
            
            # Select bands and rename to standard names
            selected = image.select(bands, ['blue', 'green', 'red', 'nir'])
    ...
    def export_hls_imagery(self, job: Job) -> Dict[str, Any]:
        ...
        try:
            ...
            export_params = {
                ...
                'bucket': 'geo-vigil-guard-exports',  # Configure this
